...
# Configuration section
checkpoint_dir = f"./outputs/3_evaluation_results/{args.book}/{args.technique_dir}/4_few_shots_without_judge"
...
for i in range(20):
    ...
    print("round", i+1)
# Configuration section
    checkpoint_file = f"./outputs/3_evaluation_results/{args.book}/{args.technique_dir}/4_few_shots_without_judge/{index}_inference_scaling.csv"
