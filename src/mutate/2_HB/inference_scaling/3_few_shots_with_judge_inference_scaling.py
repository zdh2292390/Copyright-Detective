...
valid_mutation_subname = 'few_shots_with_judge'
...
# Configuration section
checkpoint_dir = f"./outputs/3_evaluation_results/{args.book}/{args.technique_dir}/3_few_shots_with_judge"
...
for i in range(20):
    ...
    print("round", i+1)
# Configuration section
    checkpoint_file = f"./outputs/3_evaluation_results/{args.book}/{args.technique_dir}/3_few_shots_with_judge/{index}_inference_scaling.csv"
