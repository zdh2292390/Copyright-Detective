...
valid_mutations_file = f"""./outputs/2_persuasion_prompts/{args.book}/{args.technique_dir}/6_zero_shot_with_no_judge.csv"""
...
# Configuration section
checkpoint_file = f"""./outputs/3_evaluation_results/{args.book}/{args.technique_dir}/6_eval_zero_shot_with_no_judge.csv"""
