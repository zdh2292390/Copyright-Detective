...
def save_to_csv(filename, data, append=False):
    header = ["strategy", "original_text", "mutated_version"]
...
# Configuration section
    save_file = f"""./outputs/2_persuasion_prompts/{args.book}/{args.technique_dir}/6_few_shots_with_no_judge.csv"""
    ...
    for strategy in persuasion_template.keys():
        ...
        for original_text in original_questions:
            ...
            while total_mutation_attempts < 60:
                ...
                for mutated_text in mutated_versions:
                    ...
                    batch_results.append([strategy, original_text, mutated_text])
