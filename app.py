...
with st.sidebar:
    ...
    st.markdown('<div class="sidebar-section">', unsafe_allow_html=True)
    page = st.radio("Go to", ["Text Comparison", "PDF Analysis"], label_visibility="collapsed")
    st.markdown('</div>', unsafe_allow_html=True)

if page == "Text Comparison":
    st.markdown('<div class="feature-card">', unsafe_allow_html=True)
    st.markdown("### 📝 Text Comparison")
    st.markdown("Compare two text snippets to detect potential copyright infringement by analyzing similarity scores.")
    st.markdown('</div>', unsafe_allow_html=True)
    ...
    st.markdown("Upload a PDF document to automatically analyze text chunks for potential copyright infringement.")
    st.markdown('</div>', unsafe_allow_html=True)
